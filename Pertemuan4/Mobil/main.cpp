...
void Mobil3D() {
    ...
    // ======================
    // BODY UTAMA (lebih panjang & tipis)
    // ======================
    glPushMatrix();

        // warna merah sports car
        glColor3f(0.9f, 0.1f, 0.1f);

        // lebih rendah ke tanah
        glTranslatef(0.0f, 0.45f, 0.0f);

        // panjang besar, tinggi kecil
        Kotak3D(3.5f, 0.22f, 1.1f);
    ...
    glPushMatrix();
        ...
        glTranslatef(1.1f, 0.78f, 0.0f);

        // bikin efek miring
        glRotatef(-25.0f, 0.0f, 0.0f, 1.0f);

        Kotak3D(0.45f, 0.12f, 0.72f);
